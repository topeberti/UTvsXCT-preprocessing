...
setup(
    ...
    description='Database utilities and preprocessing tools for IMDEA database',
    long_description='Tools for preprocessing and managing data for the IMDEA UT vs XCT project.',
